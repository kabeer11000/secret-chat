...
import {SignManager} from "./sign-verify/ecdsa";
/*
...
export const EncryptionManager = {
    ...
    utils: {
        ...
        _ArrayBufferToBinary: async (buffer)=> {
            var binary = '';
...
export const KeyManager = async () => {
    ...
    async function __generateKey(save = true) {
        const _key = await window.crypto.subtle.generateKey(
            {
                name: "RSA-PSS",
                // Consider using a 4096-bit key for systems that require long-term security
                modulusLength: 1024, // 1024
...
export const baseRoute = "http://127.0.0.1:8787"
